...
public class SettingsMenu extends Menu {
    ...
    public SettingsMenu() {
        ...
        window.findActor("Accept").setPosition(this.window.getWidth()/2 - this.acceptButton.getWidth()/2, this.window.getHeight()* 1/11 - this.acceptButton.getHeight() /2);
        window.findActor("Reset").setPosition(this.window.getWidth()/2 - this.resetButton.getWidth()/2, this.window.getHeight()*2/11 - this.resetButton.getHeight() /2);
        window.findActor("UpTF").setPosition(this.window.getWidth()/2 - this.upTextField.getWidth()/2, this.window.getHeight()*10/13 - this.upTextField.getHeight()/2);
        window.findActor("DownTF").setPosition(this.window.getWidth()/2 - this.downTextField.getWidth()/2, this.window.getHeight()*8/13 - this.downTextField.getHeight()/2);
        window.findActor("LeftTF").setPosition(this.window.getWidth()/2 - this.leftTextField.getWidth()/2, this.window.getHeight()*6/13- this.leftTextField.getHeight()/2);
        window.findActor("RightTF").setPosition(this.window.getWidth()/2 - this.rightTextField.getWidth()/2, this.window.getHeight()*4/13 - this.rightTextField.getHeight()/2);
        window.findActor("UpLabel").setPosition(10, this.window.getHeight()*11 /13- this.upLabel.getHeight()/2);
        window.findActor("DownLabel").setPosition(10, this.window.getHeight()*9/13 - this.downLabel.getHeight()/2);
        window.findActor("LeftLabel").setPosition(10, this.window.getHeight()*7/13 - this.leftLabel.getHeight()/2);
        window.findActor("RightLabel").setPosition(10, this.window.getHeight()*5/13 - this.rightLabel.getHeight()/2);
        window.findActor("SettingsLabel").setPosition(this.window.getWidth()/2 - this.settingsLabel.getWidth()/2, this.window.getHeight()* 12/13- this.settingsLabel.getHeight()/2);
     ...
     * NOTE: keys must be spelt exactly how they are in the API
     *       e.g. capital letters at index 0
     */
